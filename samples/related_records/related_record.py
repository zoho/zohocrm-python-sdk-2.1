...
from zcrmsdk.src.com.zoho.crm.api.record import Comment, Consent, Record, FileDetails, Participants, LineTax, \
     RemindAt, Reminder, PricingDetails, RecurringActivity
...
from zcrmsdk.src.com.zoho.crm.api.record import ImageUpload,Tax
...
class RelatedRecord(object):
                                ...
                                if len(value) > 0:
                                    ...
                                    if isinstance(value[0], FileDetails):
                                        ...
                                        for image_upload in image_uploads:
                                            ...
                                            print("RelatedRecord  SequenceNumber: " + image_upload.get_sequence_number())
    ...
    def update_related_records(module_api_name, record_id, related_list_api_name):
        ...
        record_1.set_id(34096432414001)
        ...
        record_2.set_id(347706110927068)
