...
class Layout(object):
    ...
    def print_field(field):
        ...
        if multi_module_lookup is not None:
            print("Lookup name : " + str(multi_module_lookup.get_id()))
            print("Lookup Id: " + str(multi_module_lookup.get_name()))
        ...
        if pick_list_values is not None:
            for pick_list_value in pick_list_values:
                ...
                Layout.print_pick_list_value(pick_list_value)
        ...
        if pick_list_values is not None:
            for plv in pick_list_values:
                Layout.print_pick_list_value(plv)
